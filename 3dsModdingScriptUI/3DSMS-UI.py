...
def startup(): # Makes a random splash screen in the terminal
    ...
    if randomnum == 1: 
        print(r"________ ________    _________                    ")
        print(r"\_____  \\______ \  /   _____/                    ")
        print(r"  _(__  < |    |  \ \_____  \                     ")
        print(r" /       \|    `   \/        \                    ")
        print(r"/______  /_______  /_______  /                    ")
        print(r"       \/        \/        \/                     ")
        print(r"  ___ ___                __   .__                 ")
        print(r" /   |   \_____    ____ |  | _|__| ____    ____   ")
        print(r"/    ~    \__  \ _/ ___\|  |/ /  |/    \  / ___\  ")
        print(r"\    Y    // __ \\  \___|    <|  |   |  \/ /_/  > ")
        print(r" \___|_  /(____  /\___  >__|_ \__|___|  /\___  /  ")
        print(r"       \/      \/     \/     \/       \//_____/   ")
        print(r"  _________            .__        __              ")
        print(r" /   _____/ ___________|__|______/  |_            ")
        print(r" \_____  \_/ ___\_  __ \  \____ \   __\           ")
        print(r" /        \  \___|  | \/  |  |_> >  |             ")
        print(r"/_______  /\___  >__|  |__|   __/|__|             ")
        print(r"        \/     \/         |__|                    ")
    elif randomnum == 2: 
        ...
        print(r" _     ____  ____ _  __ _  _      _____  ")
        print(r"/ \ /|/  _ \/   _Y |/ // \/ \  /|/  __/  ")
        print(r"| |_||| / \||  / |   / | || |\ ||| |  _  ")
        print(r"| | ||| |-|||  \_|   \ | || | \||| |_//  ")
        print(r"\_/ \|\_/ \|\____|_|\_\\_/\_/  \|\____\  ")
        print(r" ____  ____ ____  _  ____ _____          ")
        print(r"/ ___\/   _Y  __\/ \/  __Y__ __\         ")
        print(r"|    \|  / |  \/|| ||  \/| / \           ")
        print(r"\___ ||  \_|    /| ||  __/ | |           ")
        print(r"\____/\____|_/\_\\_/\_/    \_/           ")
    elif randomnum == 3: 
        print(r"  /$$$$$$  /$$$$$$$   /$$$$$$                                         ")
        print(r" /$$__  $$| $$__  $$ /$$__  $$                                        ")
        print(r"|__/  \ $$| $$  \ $$| $$  \__/                                        ")
        ...
        print(r" /$$  \ $$| $$  | $$ /$$  \ $$                                        ")
        print(r"|  $$$$$$/| $$$$$$$/|  $$$$$$/                                        ")
        print(r" \______/ |_______/  \______/                                         ")
        print(r"")
        print(r" /$$   /$$                     /$$       /$$                          ")
        print(r"| $$  | $$                    | $$      |__/                          ")
        print(r"| $$  | $$  /$$$$$$   /$$$$$$$| $$   /$$ /$$ /$$$$$$$   /$$$$$$       ")
        print(r"| $$$$$$$$ |____  $$ /$$_____/| $$  /$$/| $$| $$__  $$ /$$__  $$      ")
        print(r"| $$__  $$  /$$$$$$$| $$      | $$$$$$/ | $$| $$  \ $$| $$  \ $$      ")
        print(r"| $$  | $$ /$$__  $$| $$      | $$_  $$ | $$| $$  | $$| $$  | $$      ")
        print(r"| $$  | $$|  $$$$$$$|  $$$$$$$| $$ \  $$| $$| $$  | $$|  $$$$$$$      ")
        print(r"|__/  |__/ \_______/ \_______/|__/  \__/|__/|__/  |__/ \____  $$      ")
        print(r"                                                       /$$  \ $$      ")
        print(r"                                                      |  $$$$$$/      ")
        print(r"                                                       \______/       ")
        print(r"  /$$$$$$                      /$$             /$$                    ")
        ...
        print(r" /$$  \ $$| $$      | $$      | $$| $$  | $$  | $$ /$$                ")
        print(r"|  $$$$$$/|  $$$$$$$| $$      | $$| $$$$$$$/  |  $$$$/                ")
        print(r" \______/  \_______/|__/      |__/| $$____/    \___/                  ")
        print(r"                                  | $$                                ")
        print(r"                                  | $$                                ")
        print(r"                                  |__/                                ")
    elif randomnum == 4:
        ...
        print(r" | |  | |          | |  (_)             ")
        print(r" | |__| | __ _  ___| | ___ _ __   __ _  ")
        print(r" |  __  |/ _` |/ __| |/ / | '_ \ / _` | ")
        print(r" | |  | | (_| | (__|   <| | | | | (_| | ")
        print(r" |_|__|_|\__,_|\___|_|\_\_|_| |_|\__, | ")
        print(r"  / ____|         (_)     | |     __/ | ")
        print(r" | (___   ___ _ __ _ _ __ | |_   |___/  ")
        print(r"  \___ \ / __| '__| | '_ \| __|         ")
        print(r"  ____) | (__| |  | | |_) | |_          ")
        print(r" |_____/ \___|_|  |_| .__/ \__|         ")
        print(r"                    | |                 ")
        print(r"                    |_|                 ")
    elif randomnum == 5:
